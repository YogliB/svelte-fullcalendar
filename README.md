...
### There is an ongoing rewrite to svelte-fullcalendar package to enhance compatibility with [FullCalendar](https://fullcalendar.io), in the meaningtime it is adviced not to install @fullcalendar/** directly into your project as the package will handle the peer dependencies.
